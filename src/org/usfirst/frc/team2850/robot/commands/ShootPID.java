...
public class ShootPID extends Command {
    ...
    public ShootPID(double setpoint) {
    ...
    protected void initialize() {
    	Robot.elevatorshooter.setSetpoint(setpoint);
    	Robot.elevatorshooter.setOutputRange(-1, 1);
    	Robot.elevatorshooter.enable();
    }
    ...
    protected boolean isFinished() {
    	...
    	System.out.println("PID output: " + Robot.elevatorshooter.getPIDController().get());
